            ...
            <div class="card-body p-5">
                    <form action='{{route('article.store')}}' method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="titre" type="text" class="form-control @error('name') is-invalid @enderror" name="titre" value="{{ old('titre') }}" required autocomplete="titre" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contenu" type="text-area" class="form-control @error('name') is-invalid @enderror" name="contenu" value="{{ old('contenu') }}" required autocomplete="titre" autofocus>
